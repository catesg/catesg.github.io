    ...
    mr.forms.submit = function(e){
        ...
        if (formAction.indexOf('createsend.com') !== -1 || formAction.indexOf('list-manage.com') !== -1 ) {
            ...
            if (error === 1) {
                ...
                var jqxhr = jQuery.post( formAction, thisForm.serialize(), function(){
                } ).done( function(){
                    //
                } ).always( function(){
...
mr = (function (mr, $, window, document){
    ...
    mr.socialShares = mr.socialShares || {};
	...
	mr.socialShares.documentReady = function($){
        ...
        $( '.js-socialShareButton' ).on( 'click', function( e ){
            ...
            switch( $( this ).attr( 'type' ) ) {
                case 'facebook':
                    var strUltimateURL = 'https://www.facebook.com/sharer/sharer.php?u=' + encodeURIComponent( $( this ).attr( 'data-posturl' ) );
                    break;
                case 'twitter':
            ...
            popup( strUltimateURL, 'From StewGiff.com', 600, 400 );
        } );

    };

    mr.components.documentReady.push(mr.socialShares.documentReady);
    return mr;
